...
| Tags of the test run (**It's optional**). Comma-separated list or JSON array                                                                                                                                                                                                                                        | testRunTags                       | TMS_TEST_RUN_TAGS                          |
| Links of the test run (**It's optional**). JSON array (`url` required; `title`/`description`/`type` optional). Types: Related, BlockedBy, Defect, Issue, Requirement, Repository                                                                                                                                   | testRunLinks                      | TMS_TEST_RUN_LINKS                         |

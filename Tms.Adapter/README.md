...
| Failed tests rerun count (**It's optional**). Default value - 0. The adapter rerun only failed tests while they exist and rerun count limit isn't exceed                                                                                                                                                                                                                               | adapterAutoTestsRerunCount | TMS_ADAPTER_AUTOTESTS_RERUN_COUNT | tmsAdapterAutoTestRerunCount  |

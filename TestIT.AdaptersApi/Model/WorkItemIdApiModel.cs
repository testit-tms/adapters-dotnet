...
namespace TestIT.AdaptersApi.Model
{
    ...
    /// WorkItemIdApiModel
    /// </summary>
    [DataContract(Name = "WorkItemIdApiModel")]
    public partial class WorkItemIdApiModel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkItemIdApiModel" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WorkItemIdApiModel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkItemIdApiModel" /> class.
        /// </summary>
        ...
        public WorkItemIdApiModel(string id = default)
        {
            ...
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for WorkItemIdApiModel and cannot be null");
            }
            this.Id = id;
        }

...
namespace TestIT.AdaptersApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AutoTestStepApiModel")]
    public partial class AutoTestStepApiModel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AutoTestStepApiModel" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AutoTestStepApiModel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AutoTestStepApiModel" /> class.
        /// </summary>
        ...
        public AutoTestStepApiModel(string title = default, string description = default, List<AutoTestStepApiModel> steps = default)
        {
            ...
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for AutoTestStepApiModel and cannot be null");
            }
            this.Title = title;

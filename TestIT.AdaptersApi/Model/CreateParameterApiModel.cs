...
namespace TestIT.AdaptersApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateParameterApiModel")]
    public partial class CreateParameterApiModel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateParameterApiModel" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateParameterApiModel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateParameterApiModel" /> class.
        /// </summary>
        ...
        public CreateParameterApiModel(string name = default, string value = default, List<Guid> projectIds = default)
        {
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CreateParameterApiModel and cannot be null");
            }
            this.Name = name;

...
//     {
//         _client.IsAutotestExist(ExternalId).Returns(_existAutotest);
...
//         _client.DidNotReceive().LinkAutoTestToWorkItems(Arg.Any<string>(), Arg.Any<string>());
//     }
//
//     [TestMethod]
...
//     {
//         _client.IsAutotestExist(ExternalId).Returns((TestResult?)null);
//         var writer = new Writer(_logger, _client);
//
//         writer.Write(_testResult);
//
...
//
//         _client.Received().CreateAutotest(_testResult);
//         _client.Received().LinkAutoTestToWorkItems(ExternalId, workItemId);
//     }
//
//     [TestMethod]
...
//         _client.IsAutotestExist(ExternalId).ThrowsAsync(exception);
//         var writer = new Writer(_logger, _client);
//
//         writer.Write(_testResult);
//
...
//         var exception = new Exception("test exception");
//         _testResult.Status = Status.Passed;
//         _client.IsAutotestExist(ExternalId).Returns(_testResult);
...
//         _testResult.Status = Status.Passed;
//         _client.IsAutotestExist(ExternalId).Returns((TestResult?)null);
//         _client.When(x => x.LinkAutoTestToWorkItems(ExternalId, workItemId))
//             .Do(x => throw exception);
//         var writer = new Writer(_logger, _client);
//
//         writer.Write(_testResult);
